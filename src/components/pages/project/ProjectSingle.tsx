      ...
      <div className="mx-auto max-w-[1320px]">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[1.4fr_1fr] md:gap-16">
          <div>
            ...
            <p
              data-ps-load
              className="mt-6 max-w-[560px] text-base leading-[1.7] text-black font-medium md:text-[17px]"
            >
              {project.description}
            </p>
          </div>
        ...
        <div className="mx-auto mt-16 max-w-[820px] md:mt-24">
          ...
          <div data-ps-reveal className="mt-10">
            ...
            <ul className="mt-5 list-disc space-y-2 pl-5 text-base leading-[1.7] text-black font-medium md:text-[17px]">

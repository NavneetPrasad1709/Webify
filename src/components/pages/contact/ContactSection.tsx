...
/* The fields are white and the panel around them is the light fill, which is
   the inversion of what was here originally: grey boxes on white read as
   scattered and inert, white boxes on grey read as inputs cut into a surface.
   It also pairs the form with the founder card beside it, which is already on
   that fill.

   The border is #767676, the one value that clears the 3:1 a control outline
   has to meet against both the white inside it and the fill behind it. The UA
   outline is replaced rather than removed, so keyboard focus stays visible. */
const fieldClasses =
  "w-full min-h-[54px] rounded-xl border border-field bg-white px-4 py-3.5 text-base text-ink placeholder:text-gray-mid transition-[border-color,box-shadow] duration-200 hover:border-ink focus:border-primary focus:shadow-[0_0_0_3px_rgba(0,81,255,0.14)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary";

const labelClasses =
  "mb-2.5 block font-mono text-[11px] font-medium uppercase tracking-[0.12em] text-ink";
        ...
        <div className="contact-content mt-16 md:mt-28 flex flex-col items-stretch justify-between gap-12 lg:flex-row lg:gap-[70px]">
          ...
          <div className="flex w-full items-center lg:max-w-[818px]">
            <div className="w-full">
              ...
              <div className="rounded-card bg-fill-light p-6 text-ink sm:p-8 md:p-10">
                <div className="mb-8 flex items-baseline justify-between gap-4 border-b border-ink/12 pb-6">
                ...
                <div className="flex flex-col items-center gap-6 py-6 text-center">
                  <span className="w-max rounded-full bg-primary px-3.5 py-1.5 font-mono text-[10px] font-semibold uppercase tracking-[0.14em] text-white">
                    Message sent
                  </span>
                  <p
                    ref={successRef}
                    tabIndex={-1}
                    className="max-w-[34ch] text-lg font-semibold leading-snug text-ink outline-none"
                  >
                    {successMessage}
                  </p>
                ...
                >
                  ...
                  <div className="field-wrap mt-2.5 md:col-span-2">
                    <button
                      type="submit"
                      disabled={sending}
                      className="block min-h-[54px] w-full cursor-pointer rounded-full bg-primary px-5 py-[15px] font-semibold text-white shadow-[0_10px_28px_rgba(0,81,255,0.28)] transition-[background-color,transform,box-shadow] duration-300 ease-out hover:-translate-y-0.5 hover:bg-primary-deep hover:shadow-[0_16px_38px_rgba(0,81,255,0.42)] active:translate-y-0 focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-primary disabled:pointer-events-none disabled:opacity-60"
                    >
                    ...
                    {error ? (
                      ...
                      <p role="alert" className="mt-4 text-center text-sm font-semibold text-ink">
                      ...
                      <p className="mt-4 text-center text-[13px] font-medium leading-relaxed text-black">

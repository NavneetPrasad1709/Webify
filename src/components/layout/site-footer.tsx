...
// Blog/Terms/Privacy are placeholders (#) until those pages exist.
const NAV_COLUMN = [
  { label: "Home", href: "/" },
...
const COMPANY_COLUMN: { label: string; href: string; external?: boolean }[] = [
  ...
  { label: "Terms and Condition", href: "#", external: true }, // [REPLACE: /terms]
  { label: "Privacy Policy", href: "#", external: true }, // [REPLACE: /privacy]
];

// Official brand glyphs (simple-icons paths). [REPLACE: real social URLs]
const SOCIALS = [
  {
    label: "Discord",
    href: "#",
      ...
      <div className="footer-wrapper">
        ...
        <div className="footer-left">
          <video
            ...
            aria-hidden="true"
          >
            {/* [REPLACE: host Webify's own footer video; this is the reference asset] */}
            <source
